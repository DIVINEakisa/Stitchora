        ...
        {step === 0 && (
          <div>
            ...
            <p className="mt-1 text-sm text-charcoal/60">
              Share sketches, inspiration photos, or reference images
            </p>
            <div className="mt-6">
              <ImageDropzone
                preview={designImage}
                onUploaded={setDesignImage}
              />
            </div>
          </div>
        )}
          ...
          <div>
            ...
            <label className="mt-4 flex cursor-pointer items-center gap-3 rounded-xl border border-primary/15 p-4 transition hover:bg-card">
              ...
              <span className="font-medium">
                Let designer choose the best fabric
              </span>
            </label>
            {!designerChoosesFabric && (
        ...
        {step === 4 && (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Fabric:{" "}
              {designerChoosesFabric
                ? "Designer will choose"
                : fabrics.find((f) => f._id === selectedFabric)?.name}
            </p>
